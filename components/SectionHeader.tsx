  ...
  return (
    <div ref={ref} data-active={active}>
      ...
      <div className="chapter-strip relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1480px] px-4 sm:px-6 lg:px-12 h-12 flex items-center justify-between font-mono text-[10px] md:text-[11px] tracking-[0.22em] uppercase">
